        ...
        <div className="max-w-[1280px] mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-10">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a href="https://www.facebook.com/profile.php?id=61550637665102&locale=vi_VN" className="flex items-center gap-3 p-2.5 rounded-xl bg-white border border-gray-200 hover:border-[#1877F2] transition-all duration-300 group">
              ...
              <a href="https://www.tiktok.com/@tritechchannel" className="flex items-center gap-3 p-2.5 rounded-xl bg-white border border-gray-200 hover:border-[#000000] transition-all duration-300 group">
              ...
              <a href="https://shopee.vn/tritechchannel?categoryId=100013&entryPoint=ShopByPDP&itemId=48668123158" className="flex items-center gap-3 p-2.5 rounded-xl bg-white border border-gray-200 hover:border-[#EE4D2D] transition-all duration-300 group">
              ...
              <a href="https://www.youtube.com/@tritechchannel" className="flex items-center gap-3 p-2.5 rounded-xl bg-white border border-gray-200 hover:border-[#FF0000] transition-all duration-300 group">
